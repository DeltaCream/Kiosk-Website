...
export default function BentoProMaxPlusPage() {
    ...
    const handleSubmit = (event) => {
        ...
        if (!checkSelectionLimits(selectedItems)) {
            alert("Please ensure that you have selected 2 main courses, 2 snacks, 1 dessert, and 1 drink.");
            return;
        }
        ...
        const saveSelection = () => {
            ...
            const newSelection = {
                name: 'Bento Pro Max Plus',//bentoName, 
                items: selectedItems
            };
    ...
    return (
        ...
        >
            <h1 className="text-6xl font-bold mb-4 text-center py-10">Bento Pro Max Plus</h1>
